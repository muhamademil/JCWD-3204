    ...
    return (
        <div className='w-screen h-20 p-4 bg-orange-500 text-white flex justify-between items-center fixed top-0'>
            ...
            <div className='flex gap-x-5 items-center'>
                <svg xmlns="http://www.w3.org/2000/svg" className='w-6 h-6 cursor-pointer' viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
